...
def train(repeat, epoch, filename, save_filename, individual):
    ...
    for r in range(repeat):
        ...
        for i in range(0, vmd_k):
            ...
            model.add(GRU(32, return_sequences=False,kernel_initializer='glorot_normal'))
        ...
        if mse < best_mse:
            ...
            ax.set_title("California_spring_20120401-20120407")
...
if __name__ == '__main__':
    ...
    repeat = 1
    epoch = 200
    filename = '../data/week_data/data/California_spring_20120401-20120407新.csv'
    save_filename = '../result/California_spring_20120401-20120407/predict/result'
