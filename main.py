...
class MOEAD:
    ...
    save_filename = 'result/washingtong_summer_20120701-20120707/'
    individual_num = 30  # num of the population
    gene_num = 10  # num of the parameters
    max_gen = 5  # num of the iteration

    gen = 0  # current generation
    object_num = 2  # num of the objective value
    epoch = 110  # num of the epoch
    trainging_repeat = 1  # num of retraining times of each each
    # final_training_time = 2  # num of the retraining time of final population
    # first_training_time = 1  # num of the retraining time of final population
    # final_epoch = 5  # num of epoch of the final generation
    c_rate = 1  # rate of crossover
    # m_rate = 0.4  # rate of mutation
...
def main_loop(P, moead):
    for gen in range(moead.max_gen):
        ...
        for pi, p in enumerate(P):
            ...
            # Y_temp.to_csv('result/washingtong_winter_20120101-20120107/generate_next_gen_' + str(gen + 1) + '_' + str(pi+1) + '_.csv',header=False, index=False)
